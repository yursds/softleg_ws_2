...
def generate_launch_description():
    ...
    inference_config  = 'rlilc_ctrl_config.yaml'
    ...
    configRL_path  = os.path.join(path_pkg, ctrl_param_folder, model_rl_folder, RL_param_file)
    weightsRL_path = os.path.join(path_pkg, ctrl_param_folder, model_rl_folder, RL_model_file)
    
    # node inference_controller
    node = Node(
        package    = 'rlilc_leg_pkg',
        name       = 'rlilc_controller',
