...
class InferenceController(Node):
    ...
    def __init__(self):
        ...
        super().__init__(node_name='rlilc_controller')
        ...
        self.timer_inference  = self.create_timer(1.0 / self.rate, self.inference_callback)
        self.timer_modelbased = self.create_timer(1.0 / self.rate, self.modelbased_callback)
    ...
    def _set_param_rl_as_attr(self):
...
def main(args=None):
    ...
    rlilc_controller = InferenceController()
