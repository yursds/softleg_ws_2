...
def generate_launch_description():
    ...
    command = Node(
        ...
        name       = 'command_trajectory_node',        # the name is set in the main of inference_ctrl_node_sim
        executable = 'command_trajectory_node',    # the name of executable is set in setup.py
        parameters = [
